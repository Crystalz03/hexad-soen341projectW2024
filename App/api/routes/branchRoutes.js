...
router.post('/branches', async (req, res) => {
    ...
    try {
      const result = await pool.query`INSERT INTO Branch (BranchName, LatitudeCoord, LongitudeCoord, ID, Address) VALUES (${BranchName}, ${LatitudeCoord}, ${LongitudeCoord}, ${ID}, ${Address})`;
...
router.put('/branches/:id', async (req, res) => {
  ...
  try {
    const result = await pool.query`UPDATE Branch SET BranchName = ${BranchName}, LatitudeCoord = ${LatitudeCoord}, LongitudeCoord = ${LongitudeCoord}, Address = ${Address} WHERE ID = ${branchId}`;
