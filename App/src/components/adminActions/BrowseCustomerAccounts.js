...
import "../../../public/css/accountsView.css";
...
function BrowseAccountsComponent() {
  ...
  const filteredAccounts = apiResponse
    ? apiResponse.filter((customer) => customer.Email.includes(emailFilter))
    : [];
  ...
  return (
    <div>
      <div>
        ...
        <div>
          <label className="location-title" htmlFor="emailFilter">
            Filter by Email:
          </label>
          <input
            type="text"
